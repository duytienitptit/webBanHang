        ...
        <div className='hero-container relative py-16 mb-16 overflow-hidden' style={{ minHeight: '600px' }}>
          ...
          <div className='container mx-auto px-4 flex flex-col md:flex-row items-center justify-between relative z-10'>
            ...
            <div className='md:w-1/2 text-center md:text-left mb-10 md:mb-0'>
              ...
              <p className='text-xl md:text-2xl mb-6 text-gray-600'>The next generation of innovation.</p>
              ...
              <div className='flex flex-col sm:flex-row gap-4'>
                <Link
                  ...
                  className='bg-[var(--color-apple-blue)] text-white px-6 py-3 rounded-full text-lg font-medium hover:bg-[var(--color-apple-darkblue)] transition-all hover:scale-105 shadow-md'
                >
                  Learn more
                </Link>
                <button
                ...
                >
                  {featured.stock > 0 ? 'Add to Cart' : 'Out of Stock'}
                </button>
              </div>
            </div>
